...
public class InstructionProcessor {
  ...
  public long awaitOutput() throws TimeoutException {
  ...
  private void input(ParameterMode[] parameterModes) {
    ...
    long input;
    try {
      input = awaitValue(inputRecorder);
  ...
  private static long awaitValue(IORecorder ioRecorder) throws TimeoutException {
    try {
